...
data class AppThemeConfig(
    ...
    companion object {
        operator fun invoke(config: ThemeConfig): AppThemeConfig = AppThemeConfig(
            config = config,
            isSystemOsSwitchAvailable = currentThemeCapability.isSystemOsSwitchAvailable,
            isSystemDynamicColorAvailable = currentThemeCapability.isSystemDynamicColorAvailable,
        )
