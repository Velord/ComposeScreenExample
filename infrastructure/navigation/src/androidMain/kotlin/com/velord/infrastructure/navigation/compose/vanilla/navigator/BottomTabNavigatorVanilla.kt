...
private val log = Logger.withTag("LogBackStack - BottomTabNavigatorVanilla")
...
internal fun onTabClickVanilla(
    ...
    if (isSelected) {
        val msg = "onTabClickVanilla: Selected same tab ($item). Popping to start."
        log.d { msg }
    ...
    log.d { "onTabClickVanilla: Navigating to $item" }
