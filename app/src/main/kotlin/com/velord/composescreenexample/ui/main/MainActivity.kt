...
import com.velord.infrastructure.navigation.AndroidNavigationHost
import com.velord.infrastructure.navigation.ContainerParameter
import com.velord.infrastructure.navigation.JetpackParameter
...
//    └─ toastOverlay         // Global toast, always above both
    ...
    private fun setNavGraph() {
        val jetpackParameter = JetpackParameter(
            fragmentManager = supportFragmentManager,
            fragmentContainerId = fragmentContainer,
            destination = null,
            bundle = Bundle()
        )
        val containerParameter = ContainerParameter(
            composeView = b.mainNavHost,
            fragmentView = b.navHostFragment
        )
        AndroidNavigationHost.resolveNavigation(
            navigationLib = mainVM.navigationLib,
            containerParameter = containerParameter,
            jetpackParameter = jetpackParameter,
            installComposeContent = { content ->
                b.mainNavHost.setContentAfterSplash {
                    content()
                }
            },
        )
