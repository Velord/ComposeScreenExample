...
class MovieGateway(
    ...
    private val roster = MutableStateFlow<List<Movie>>(
        listOf(
            Movie(
                id = 1,
                title = "Star Wars",
            ...
            Movie(
                ...
                isLiked = false,
                createCalendar(1994, 9, 23) // Release date
            ),
            Movie(
                id = 4,
                title = "The Godfather",
            ...
            Movie(
                ...
                isLiked = false,
                createCalendar(1987, 9, 25) // Release date (USA)
            ),
            Movie(
                id = 21,
                ...
                isLiked = false,
                createCalendar(2004, 3, 10) // Release date (South by Southwest)
            ),
            Movie(
                id = 22,
                title = "Spirited Away",
                ...
                isLiked = false,
                createCalendar(2001, 7, 20) // Release date (Japan)
            ),
            Movie(
                id = 23,
                title = "The Farewell",
                ...
                isLiked = false,
                createCalendar(2019, 4, 26) // Release date (Tribeca Film Festival)
            ),
            Movie(
                id = 24,
                ...
                isLiked = false,
                createCalendar(2015, 5, 14) // Release date (Cannes Film Festival)
            ),
            Movie(
                id = 25,
                title = "Amélie",
                ...
                isLiked = false,
                createCalendar(2001, 4, 25) // Release date (France)
            ),
            Movie(
                id = 26,
                ...
                isLiked = false,
                createCalendar(2016, 2, 8) // Release date (China)
            ),
            Movie(
                id = 27,
                ...
                isLiked = false,
                createCalendar(2014, 2, 6) // Release date (Berlin International Film Festival)
            ),
            Movie(
                id = 28,
                title = "WALL-E",
                ...
                isLiked = false,
                createCalendar(2008, 6, 27) // Release date (USA)
            ),
            Movie(
                ...
                isLiked = false,
                createCalendar(2019, 4, 26) // Release date (USA)
            ),
            Movie(
                id = 30,
                ...
                isLiked = false,
                createCalendar(2019, 3, 8) // Release date (USA)
            ),
            Movie(
                id = 31,
                title = "Aladdin",
                ...
                isLiked = false,
                createCalendar(2019, 5, 24) // Release date (USA)
            ),
            Movie(
                id = 32,
                title = "The Lion King",
                ...
                isLiked = false,
                createCalendar(2019, 7, 19) // Release date (USA)
            ),
            Movie(
                id = 33,
                title = "Toy Story 4",
                ...
                isLiked = false,
                createCalendar(2019, 6, 21) // Release date (USA)
            ),
            Movie(
                id = 34,
                ...
                isLiked = false,
                createCalendar(2019, 7, 2) // Release date (USA)
            ),
            Movie(
                id = 35,
                ...
                isLiked = false,
                createCalendar(2019, 9, 6) // Release date (USA)
            ),
            Movie(
                id = 36,
                title = "Joker",
                ...
                isLiked = false,
                createCalendar(2019, 10, 4) // Release date (USA)
            ),
            Movie(
                id = 37,
                title = "Knives Out",
                ...
                isLiked = false,
                createCalendar(2019, 11, 27) // Release date (USA)
            ),
            Movie(
                id = 38,
                title = "Jojo Rabbit",
                ...
                isLiked = false,
                createCalendar(2019, 10, 18) // Release date (Toronto International Film Festival)
            ),
            Movie(
                id = 39,
                ...
                isLiked = false,
                createCalendar(2019, 11, 15) // Release date (USA)
            ),
            Movie(
                id = 40,
                ...
                isLiked = false,
                createCalendar(2019, 11, 22) // Release date (USA)
            ),
            Movie(
                id = 41,
            ...
            Movie(
                ...
                isLiked = false,
                createCalendar(2019, 12, 25) // Release date (USA)
            ),
            Movie(
                id = 43,
                ...
                isLiked = false,
                createCalendar(2019, 11, 6) // Release date (limited)
            ),
            Movie(
                id = 44,
                title = "Clemency",
                ...
                isLiked = false,
                createCalendar(2019, 1, 27) // Release date (Sundance Film Festival)
            ),
            Movie(
                id = 45,
                title = "The Farewell",
            ...
            Movie(
                ...
                isLiked = false,
                createCalendar(2019, 5, 15) // Release date (Cannes Film Festival)
            ),
            Movie(
                id = 47,
                ...
                isLiked = false,
                createCalendar(2019, 5, 18) // Release date (Cannes Film Festival)
            )
        )
    )
